...
contract UniNoRevertOnTransfer {
    ...
    function transfer(address dst, uint rawAmount) external returns (bool) {
        ...
        bool success = _transferTokens(msg.sender, dst, amount);
        return success;
    }
    ...
    function transferFrom(
        ...
        bool success = _transferTokens(src, dst, amount);
        return success;
    }
    ...
    function _transferTokens(
        ...
        if (
            ...
            dst != address(0) &&
            balances[src] >= amount &&
            (balances[dst] + amount) > balances[dst]
        ) {
